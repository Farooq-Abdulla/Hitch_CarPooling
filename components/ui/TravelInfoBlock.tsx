...
import { ContentClicked, CorouselCurrent, DateFormatted, DropOff, GoToConf, PickUp, ProductClick, ProductDetails } from "@/lib/RecoilContextProvider";
...
const TravelInfoBlock = () => {
    ...
    const [formattedDate, setFormattedDate] = useRecoilState(DateFormatted)
    // console.log("PickUp and DropOff: ", pickUp, dropOff)


    const res = date?.toLocaleDateString('en-US', {
        weekday: 'long',
        month: 'long',
        day: 'numeric',
    });
    ...
    return (
        <div>
            {!confirmationBlock && <div className='w-[464px] p-[16px] max-h-full no-scrollbar overflow-y-auto bg-[#FFFFFFce] absolute z-10 mx-3 bottom-3 '>
