    ...
    return (
        <div className='sticky top-0 h-[56px] bg-black text-white px-[40px] flex items-center justify-between  z-10 ' >
            ...
            <div className="text-sm">
                ...
                {res ? <span className="cursor-pointer px-[8px] py-[10px] my-[4px] mx-3 hover:bg-gray-600 hover:rounded-md" onClick={() => { localStorage.removeItem("uid"), signOut(auth), router.push("/") }}>SignOut</span> : null}
                {/* <ServerNavBarSignOut /> */}
